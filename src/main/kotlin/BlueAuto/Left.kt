...
class Left {
    ...
    private val carouselPose = Pose2d(55.0, 60.0, -90.0.toRadians)
    ...
    fun createTrajectory(): ArrayList<Trajectory> {
        ...
        builder2.strafeRight(20.0).splineToConstantHeading(Vector2d(deposit2.x, deposit2.y), deposit2.heading);
